...
async def command_start_handler(message: Message, bot: Bot, state: FSMContext) -> None:
    ...
    if is_new_user:
        ...
        guide_text = (
            ...
            "🎁 <b>Всё это БЕСПЛАТНО первые 3 месяца!</b>\n"
        ...
        action_builder.button(text="🎁 Активировать 3 месяца бесплатно", callback_data="activate_free_period")
        ...
        call_to_action = (
            ...
            "🔹 Нажмите кнопку ниже, чтобы <b>активировать 3 месяца бесплатного доступа</b>\n"
            ...
            "Помогите близким найти духовную поддержку — пусть они тоже получат 3 месяца бесплатного доступа.\n\n"
    ...
    if free_period_start is None:
        builder.button(text="🎁 Активировать 3 месяца бесплатно", callback_data="activate_free_period")
    ...
    if has_subscription:
        ...
        status_text = "✨ У вас активен бесплатный период на 3 месяца! Наслаждайтесь всеми функциями бота."
