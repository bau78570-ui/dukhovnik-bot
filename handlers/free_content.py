...
async def terms_handler(message: Message, bot: Bot, state: FSMContext):
    """
    Обработчик для команды /terms.
    Отправляет условия использования.
    """
    terms_text = (
        "📄 <b>Условия использования</b>\n\n"
        "1. Бот «Духовник» является AI-собеседником и не заменяет реального священника.\n"
        "2. Ответы AI генерируются на основе больших языковых моделей и могут содержать неточности.\n"
        "3. Мы не храним историю ваших диалогов. Ваша конфиденциальность важна для нас.\n"
